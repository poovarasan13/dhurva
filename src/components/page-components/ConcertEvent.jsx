...
const ConcertEvent = () => {
    ...
    return (
        <div className="bg-white text-black min-h-screen">
            ...
            >
                <h1 className="text-4xl md:text-5xl font-extrabold" style={{ color: '#2664EB' }}>
            ...
            {/* Hero Section */}
            <motion.section
                className="relative px-4 md:px-8 py-10" // Adjusted padding here
                initial="hidden"
                animate="visible"
                ...
                <div className="w-full px-4">
                    <div className="flex flex-wrap items-center justify-between max-w-7xl mx-auto">
                        <div className="w-full md:w-7/12 text-center md:text-left max-w-lg">
                            <h2 className="text-2xl  md:text-5xl font-bold " style={{ color: '#2664EB' }}>
                                Let's Rock!
                            </h2>
                            ...
                            <div className="mt-6 flex items-center justify-center md:justify-start gap-4">
                                <Calendar className="text-[#2664EB]" size={24} />
            ...
            <div className="px-11 ">
                <motion.section
                    ...
                    transition={{ duration: 0.5 }}
                >
                    <h3 className="text-2xl  md:text-5xl font-bold " style={{ color: '#2664EB' }}>
                        Live-in Concert
                    </h3>
           ...
           <motion.section
            ...
            >
                ...
                <ul className="mt-4 text-gray-700 list-disc space-y-3 pl-6 md:pl-8 josefin">
                    <li className="text-xl">Each participant should carry their respective identity proof.</li>
                    <li className="text-xl">Participants should refrain from abusive language and obscene displays.</li>
                    <li className="text-xl">Event organizers have the right to deny entry to anyone.</li>
                    <li className="text-xl">Consumption of alcohol is strictly prohibited.</li>
                </ul>
            </motion.section>
           </div>
